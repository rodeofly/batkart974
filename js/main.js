...
(function() {
  var CardSet, citations, couleurs, niveaux, signifiants, unique_id;
  ...
  CardSet = (function() {
    function CardSet(_at_theme, _at_attendus) {
      var a, attendu, attenduV, carte, id, n, niveau, nombre_attendus, nombre_notions, notion, notionV, notions, notionsV, numero_attendu, numero_notion, recto, savoirfaire, savoirfaires, savoirfairesV, verso, _ref, _ref1;
      this.theme = _at_theme;
      this.attendus = _at_attendus;
      this.set = [];
      numero_attendu = 0;
      nombre_attendus = Object.keys(this.attendus).length;
      _ref = this.attendus;
      for (attendu in _ref) {
        notions = _ref[attendu];
        numero_attendu++;
        numero_notion = 0;
        ...
        for (notion in notions) {
          ...
          recto.append("<div class='theme'>" + this.theme + "</div>");
          recto.append("<div class='citation'>" + citations[this.theme] + "</div>");
          if (signifiants[this.theme][attendu] !== "") {
            recto.append("<div class='signifiant'>Signifiant / " + signifiants[this.theme][attendu] + "</div>");
          }
          ...
          verso.append("<div class='theme'>" + this.theme + "</div>");
          verso.append("<ul id='attendus'></ul>");
          a = 0;
          _ref1 = this.attendus;
          for (attenduV in _ref1) {
            notionsV = _ref1[attenduV];
            a++;
            if (a === numero_attendu) {
  ...
  $(function() {
    var attendus, s, set, theme, _results;
    alert("go");
    _results = [];
